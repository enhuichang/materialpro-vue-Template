    ...
    routes: [
        {
            ...
            children: [
                ...
                },
                {
                    ...
                    component: () => import('@/views/form-layouts/form-action/FLFormAction'),
                },
                {
                    name: 'FLFormBasic',
                    path: 'form-layouts/FLFormBasic',
                    component: () => import('@/views/form-layouts/form-basic/FLFormBasic'),
                },
                {
                    name: 'FormWizard',
                    path: 'form-layouts/FormWizard',
                    component: () => import('@/views/form-layouts/form-wizard/FormWizard'),
                },
                {
                    name: 'DragnDrop',
                    path: 'extra-components/DragnDrop',
                    component: () => import('@/views/extra-components/drag-n-drop/DragnDrop'),
                },
                {
                    name: 'FLFormHorizontal',
                    path: 'form-layouts/FLFormHorizontal',
                    component: () => import('@/views/form-layouts/form-horizontal/FLFormHorizontal'),
                },
                {
                    name: 'TableSimple',
                ...
                },
                {
                    ...
                    component: () => import('@/views/tables/table-data-iterators/TableDataIterators'),
                },
                {
                    name: 'TableDatatable',
                    path: 'tables/TableDatatable',
                    component: () => import('@/views/tables/table-data-table/TableDatatable'),
                },
                {
                    name: 'FormValidation',
                    path: 'form-layouts/FormValidation',
                    component: () => import('@/views/form-layouts/form-validation/FormValidation'),
                },
                {
                    name: 'MaterialIcons',
