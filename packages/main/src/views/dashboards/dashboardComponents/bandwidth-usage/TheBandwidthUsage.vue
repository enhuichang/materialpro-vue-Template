  ...
  <v-card flat class="mb-7">
    <v-card-text class="pa-5 deep-purple accent-2">
      <div class="d-flex align-center">
        ...
        <div class="mx-4">
          <h3 class="card-title white--text title font-weight-regular">Bandwidth usage</h3>
          <h6 class="card-subtitle white--text op-5 subtitle-2 font-weight-regular">March 2021</h6>
        </div>
      </div>
      <v-row class="mt-1">
