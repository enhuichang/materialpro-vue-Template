            ...
            >
              <td>
                <div class="d-flex align-center">
                  ...
                  />
                  <div class="mx-4">
                    <h4 class="font-weight-medium text-no-wrap">{{ item.leadname }}</h4>
                    <h6
              ...
              <td>
                <h5 class="font-weight-light text-no-wrap subtitle-2">{{ item.projectname }}</h5>
              </td>
              <td>
                <v-chip class="ma-2" :class="item.statuscolor" small label>{{ item.statustext }}</v-chip>
              </td>
              <td>
